  ...
  return (
    <div className="h-screen flex flex-col bg-[#050505]">
      ...
      <main className="flex-1 flex overflow-hidden print:overflow-visible relative" onMouseMove={(e: any) => isResizing && resize(e)} onMouseUp={stopResizing}>
        ...
        {/* MODO GENERADOR (Con Sidebar Redimensionable) */}
        ...
        {/* MODO ARGUMENT BUILDER (STANDALONE) */}
        ...
        {/* MODO SENTENCE BUILDER (STANDALONE) */}
        ...
        {/* MODO DOCUMENT ANALYSIS (STANDALONE) */}
        ...
        {appMode === AppMode.APPS && (
            <div className="flex-1 h-full">
                <AppsGrid 
                    ...
                    onAction={(cost) => {
                        // Assuming AppsGrid passes raw token cost, apply multiplier
